!function () {
    ...
    location.href.indexOf("dev.web") < 0 ? angular.module("exceptionOverride", []).factory("$exceptionHandler", [function () {
                ...
                setTimeout(function a() {
                    ...
                    function e(o) {
                        u.initContact(o).then(function (o) {
                            u.addContacts(o.MemberList), M.report(M.ReportType.timing, {timing: {initContactEnd: Date.now()}, needSend: !0}), 16 >= t && o.Seq && 0 != o.Seq && (t++, e(o.Seq))
                        })
                    }
        ...
        t.search = function () {
            A && o.cancel(A), A = o(function () {
                return t.keyword ? (I && I.close(), void(I = c.open({
                    templateUrl: "searchList.html", controller: ["$rootScope", "$scope", "$state", function (e, t, o) {
                        t.$watch(function () {
                    ...
                    }, className: "recommendation", autoFoucs: !1, container: angular.element(document.querySelector("#search_bar"))
                }))) : void(I && I.close())
            }, 200)
        ...
        t.$on("ngDialog.opened", function (e, t) {
            ...
            if (t.account) {
                ...
                c.open({
                    templateUrl: "profile_mini.html", className: "profile_mini_wrap scale-fade", top: n, left: a, blurClose: !0, singletonId: "mmpop_profile", controller: ["$scope", function (e) {
                    ...
                    case 200:
                        t.newLoginPage(i.redirect_uri).then(function (t) {
                            ...
                            return u ? void(window.location.href = u[1]) : (e.$emit("newLoginPage", {
                                ...
                                Passticket: l && l[1],
                                Code: a
                            }), void(o.getCookie("webwx_data_ticket") || n.report(n.ReportType.cookieError, {text: "webwx_data_ticket 票据丢失", cookie: document.cookie})))
                        });
                        break;
                    case 201:
    ...
    angular.module("Controllers").controller("contentChatController", ["$scope", "$timeout", "$state", "$log", "$document", "$compile", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "chatroomFactory", "mmpop", "ngDialog", "preview", "reportService", "mmHttp", "emojiFactory", function (e, t, o, n, r, a, i, c, s, l, u, f, d, g, m, p, h, M, y) {
        ...
        e.delState = !1, e.chatContent = [], e.isShowChatRoomMembers = !1, e.$on("message:add:success", function (t, o) {
            ...
            if (!c) {
                var l;
                l = "undefined" == typeof t.MMStatus || t.MMStatus == u.MSG_SEND_STATUS_SUCC ? {url: r, msg: t, preview: o} : {msg: t, preview: o}, a = w(i, l)
            }
            return a
            ...
            d - t.pageX < l && (C = t.pageX - l), p - t.pageY < f && (h = t.pageY - f), g.open({
                ...
                controller: ["$scope", function (e) {
                    e.contact = a, e.MMDefaultRemark = MM.context("8d521cc"), e.addUserContent = MM.context("5a97440") + y.formatHTMLToSend(c.getUserInfo().NickName), e.isShowSendBox = r || !1, e.chat = function (t) {
                        ...
                        s.verifyUser({UserName: a.UserName, Opcode: u.VERIFYUSER_OPCODE_VERIFYOK, Scene: u.ADDSCENE_PF_WEB, Ticket: a.Ticket}).then(function () {
                            e.closeThisMmPop()
                        }, function () {
                        ...
                        return t && -1 === [8, 37, 39, 46, 13].indexOf(t.keyCode) && r > 13 ? void t.preventDefault() : void(t && 13 != t.keyCode || (n.length > 17 && (n = n.substring(0, 18)), e.editing = !1, e.contact.RemarkName = n, M({
                            ...
                            data: angular.extend({UserName: e.contact.UserName, CmdId: u.oplogCmdId.MODREMARKNAME, RemarkName: y.formatHTMLToSend(n)}, c.getBaseRequest()),
                        ...
                        s.verifyUser({UserName: a.UserName, Opcode: u.VERIFYUSER_OPCODE_SENDREQUEST, Scene: u.ADDSCENE_PF_WEB, Ticket: a.Ticket, VerifyContent: o || ""}).then(function () {
                            e.closeThisMmPop()
                        }, function (t) {
                            e.closeThisMmPop(), m.openConfirm({
                                className: "default ", templateUrl: "comfirmTips.html", controller: ["$scope", function (e) {
        ...
        e.playVoice = function (e) {
            require.async(["jplayer"], function () {
                ...
                e.MMVoiceUnRead && (e.MMVoiceUnRead = !1), e.MMPlaying = !0, b.jPlayer({
                    ...
                    }, pause: T, ended: T, swfPath: window.MMSource.jplayerSwfPath, solution: "html, flash", supplied: "mp3", wmode: "window"
    ...
    angular.module("Controllers").controller("chatSenderController", ["$rootScope", "$scope", "$http", "$timeout", "ngDialog", "confFactory", "accountFactory", "contactFactory", "chatFactory", "screenShotFactory", "utilFactory", "mmpop", "stateManageService", "emojiFactory", "reportService", function (e, t, o, n, r, a, i, c, s, l, u, f, d, g, m) {
        ...
        t.editAreaKeyup = function (e) {
            if (MMDEV && e.keyCode == a.KEYCODE_NUM2 && "@" == C(1)) {
                ...
                w(), G = function () {
                    ...
                    h(), f.open({
                        ...
                        left: k,
                        top: F,
                        scope: {chatRoomUserName: o, memberList: angular.copy(e), insertContactToEditArea: t.insertToEditArea},
                        autoFoucs: !1,
            ...
            var o = s.createMessage({MsgType: a.MSGTYPE_EMOTICON, Content: e, EmojiFlag: a.EMOJI_FLAG_GIF, EMoticonMd5: e});
        ...
        var Y, B = 10, H = 20, j = {bmp: 1, png: 1, jpeg: 1, jpg: 1, gif: 0}, q = function (e) {
            ...
            onQueued: function () {
                return "gif" == this.ext.toLowerCase() ? (this.MMSendMsg = s.createMessage({MsgType: a.MSGTYPE_EMOTICON, EmojiFlag: a.EMOJI_FLAG_GIF}), void function (e) {
                ...
                var o = this;
                m.report(m.ReportType.uploaderError, {text: "chooseFile 上传失败", reason: e, fileName: this.ext, fileSize: this.size}), t.$apply(function () {
            ...
            onQueued: function () {
                ...
                m.report(m.ReportType.uploaderError, {text: "pasteImg 上传失败", reason: e, fileName: this.ext, fileSize: this.size}), alert(MM.context("c5795a7") + e)
            }
        };
    ...
    angular.module("Controllers").controller("createChatroomController", ["$rootScope", "$scope", "$timeout", "$state", "$log", "$document", "chatFactory", "contactFactory", "appFactory", "chatroomFactory", "confFactory", "mmpop", "ngDialog", "utilFactory", "stateManageService", "accountFactory", function (e, t, o, n, r, a, i, c, s, l, u, f, d, g, m, p) {
        ...
        t.pickConfig = {types: ["star", "friend"], opt: {star: {}, friend: {isWithoutStar: !0, isWithoutBrand: !0}, all: {filterContacts: h}}}, t.add = function () {
    ...
    angular.module("Controllers").controller("contextMenuController", ["$rootScope", "$scope", "$state", "contextMenuFactory", "accountFactory", "confFactory", "contactFactory", "ngDialog", "chatroomFactory", "emojiFactory", "utilFactory", "chatFactory", function (e, t, o, n, r, a, i, c, s, l, u, f) {
        function d(e) {
            ...
            for (var n = [e.target], r = e.path || e.originalEvent.path || o(e.target), a = 0, i = r.length; i > a; a++) {
                ...
                if (c) {
                    switch (c = JSON.parse(c), t.isShowContextMenu = !0, t.contextStyle = {top: e.pageY, left: e.pageX}, c.type) {
                        case"chat":
                    ...
                    d - e.pageX < u && (t.contextStyle = {top: e.pageY, left: e.pageX - u}), M - e.pageY < f && (t.contextStyle = {top: e.pageY - f, left: e.pageX - u});
                    break
                }
            }
        }
        ...
        function g(o) {
            ...
            (n.isRoomContact() || n.isContact()) && t.contextMenuList.push(n.isTop() ? {
                content: MM.context("84e4fac"), callback: function () {
                    i.setTopContact(o, !1)
                }
            } : {
                ...
                content: MM.context("1f9be6d"), callback: function () {
                    c.open({
                        className: "default chatroom_topic", template: "editorDialog.html", controller: ["$scope", function (e) {
        ...
        function h(o, n, s, l, d) {
            ...
            switch (+n) {
                case a.MSGTYPE_TEXT:
                    ...
                    p = y ? y + ":" + m.MMActualContent : m.MMActualContent, p = p.replace(":", ": "), t.contextMenuList.push({
                        content: MM.context("3b61c96"), callback: function () {
            ...
            (m.MsgType == a.MSGTYPE_TEXT || m.MsgType == a.MSGTYPE_APP && m.AppMsgType == a.APPMSGTYPE_ATTACH) && t.contextMenuList.push({
                content: MM.context("21e106f"), callback: function () {
                    c.open({templateUrl: "transpond.dialog.html", controller: "transpondDialogController", className: "default transpond-dialog", data: {msg: m}})
                }
    ...
    angular.module("Controllers").controller("transpondDialogController", ["$rootScope", "$scope", "$timeout", "$state", "$log", "$document", "chatFactory", "contactFactory", "appFactory", "chatroomFactory", "confFactory", "mmpop", "ngDialog", "utilFactory", "stateManageService", "accountFactory", function (e, t, o, n, r, a, i, c, s, l, u, f, d, g, m, p) {
        ...
        t.pickConfig = {types: ["chatroom", "star", "friend"], opt: {star: {}, chatroom: {isSaved: !0}, friend: {isWithoutStar: !0, isWithoutBrand: !0}}};
        ...
        var s = {
            globalData: {chatList: []}, init: function () {
                ...
                return c({
                    ...
                    data: {BaseRequest: {Uin: n.getUin(), Sid: n.getSid(), Skey: n.getSkey(), DeviceID: n.getDeviceID()}}
                }).success(function (t) {
                    e.resolve(t)
                }).error(function (t) {
                    e.reject("error:" + t)
                ...
                return c({
                    ...
                    e.resolve(t), a.getCookie("webwx_data_ticket") || i.report(i.ReportType.cookieError, {text: "webwx_data_ticket 票据丢失", cookie: document.cookie})
                }).error(function (t) {
                ...
                return window.synccheck && (window.synccheck.selector = 0), $.ajax({url: s, dataType: "script", timeout: 35e3}).done(function () {
        ...
        var _chatList = [], _chatListInfos = [], _chatMessages = window._chatContent = {}, _currentUserName = "", _addedMsgIdsMap = {}, _msgMap = {}, service = {
            setCurrentUserName: function (e) {
                ...
                data.FromUserName = msg.FromUserName, data.ToUserName = msg.ToUserName, data.LocalID = msg.LocalID, data.ClientMsgId = msg.ClientMsgId, data = angular.extend(accountFactory.getBaseRequest(), {Msg: data}), utilFactory.browser.msie && parseInt(utilFactory.browser.version) < 9 && url == confFactory.API_webwxsendmsg && (data = eval("'" + JSON.stringify(data) + "'")), mmHttp({
                    ...
                    reportService.report(reportService.ReportType.netError, {text: "postMessage error", url: url, res: e}), msg.MMStatus = confFactory.MSG_SEND_STATUS_FAIL
                })
                ...
                if (t > -1) {
                    ...
                    angular.extend(l, {MMRecall: !0, MsgType: confFactory.MSGTYPE_SYS, MMActualContent: o + i, MMDigest: o + i, _h: 0}), n.getChatList()
                }
                ...
                $http({
                    ...
                    data: angular.extend(accountFactory.getBaseRequest(), {Code: t, FromUserName: accountFactory.getUserName(), ToUserName: e, ClientMsgId: utilFactory.now()})
                }).success(function () {
                }).error(function () {
                })
    ...
    angular.module("Services").factory("chatroomFactory", ["$rootScope", "$timeout", "$http", "$q", "contactFactory", "accountFactory", "emojiFactory", "confFactory", "utilFactory", "reportService", "mmHttp", function (e, t, o, n, r, a, i, c, s, l) {
        var u, f = {}, d = {
            setCurrentContact: function (e) {
                ...
                var t = n.defer(), r = angular.extend({MemberCount: e.length, MemberList: e, Topic: ""}, a.getBaseRequest());
                return o({method: "POST", url: c.API_webwxcreatechatroom + "?r=" + s.now(), data: r}).success(function (e) {
                    ...
                    t.reject(e), l.report(l.ReportType.netError, {text: "create classroom net error", url: c.API_webwxcreatechatroom, params: r})
                }), t.promise
    ...
    angular.module("Services").factory("accountFactory", ["$q", "confFactory", "utilFactory", function (e, t, o) {
        var n, r, a, i = {}, c = null, s = {
            ...
            openNotify: function () {
                ...
                return {BaseRequest: {Uin: this.getUin(), Sid: this.getSid(), Skey: this.getSkey(), DeviceID: this.getDeviceID()}}
    ...
    angular.module("Services").factory("contactFactory", ["$rootScope", "$http", "$q", "$timeout", "confFactory", "accountFactory", "emojiFactory", "utilFactory", "resourceService", "reportService", "mmHttp", function (e, t, o, n, r, a, i, c, s, l, u) {
        ...
        var d, g = window._contacts = {}, m = window._strangerContacts = {}, p = [], h = [], M = [], y = [], C = window._chatRoomMemberDisplayNames = {}, v = [], w = [], S = [], b = {}, T = {}, E = 0, N = ["fmessage"], P = {
            ...
            contactChangeFlag: "", setCurrentContact: function (e) {
                ...
                var n = o.defer();
                return t({method: "GET", url: r.API_webwxgetcontact, params: {skey: a.getSkey(), pass_ticket: a.getPassticket(), seq: e, r: c.now()}}).success(function (e) {
                    n.resolve(e)
                }).error(function (e) {
                    n.reject("error:" + e), l.report(l.ReportType.netError, {text: "init contact", url: r.API_webwxgetcontact, params: {skey: a.getSkey(), pass_ticket: a.getPassticket()}})
                }), n.promise
            }, specialContactHandler: function (e) {
                var t = {weixin: MM.context("6c2fc35"), filehelper: MM.context("eb7ec65"), newsapp: MM.context("0469c27"), fmessage: MM.context("a82c4c4")};
                ...
                o && o.isRoomContact() && !o.MMBatchgetMember && o.MemberList.length > 0 && (o.MMBatchgetMember = !0, angular.forEach(o.MemberList, function (e) {
                    ...
                    !n || n.isContact() || n.MMFromBatchget || t.addBatchgetContact({UserName: n.UserName, EncryChatRoomId: o.UserName})
                }))
                ...
                return S.length ? (i = S.length < 6 || E > 2 ? 1 : S.length < 40 ? 5 : 10, w = S.splice(0, i), console.log("_contactsWithErrorToGetList lenght:", S.length)) : w = v.splice(0, 50), t({
                    ...
                    l.report(l.ReportType.netError, {text: "batchGetContact", url: r.API_webwxbatchgetcontact}), n.reject(e)
                }), n.promise
                ...
                for (var n, r, a, i = [], c = this, s = t.all || {}, l = 0; l < e.length; l++)switch (n = e[l], a = t[n] || {}, a = $.extend({}, a, s), n) {
                    case"star":
                        r = c.getAllStarContact(a), r.length > 0 && (a.noHeader || i.push({text: MM.context("f13fb20"), type: "header"}), [].push.apply(i, r));
                        break;
                    case"friend":
                        ...
                        break;
                    case"chatroom":
                        r = c.getAllChatroomContact(a), r.length > 0 && (a.noHeader || i.push({text: MM.context("4b0ab7b"), type: "header"}), [].push.apply(i, r));
                        break;
                    case"brand":
                        r = c.getAllBrandContact(a), r.length > 0 && (t[n].noHeader || i.push({text: MM.context("215feec"), type: "header"}), [].push.apply(i, r))
                }
                ...
                return t({method: "POST", url: r.API_webwxverifyuser + "?r=" + c.now(), data: angular.extend(a.getBaseRequest(), i)}).success(function (e) {
                    e.BaseResponse && 0 == e.BaseResponse.Ret ? n.resolve(e) : (n.reject(e), l.report(l.ReportType.netError, {text: "添加验证好友，服务器返回错误", url: r.API_webwxverifyuser, params: i, res: e}))
                }).error(function (e) {
                    n.reject(e), l.report(l.ReportType.netError, {text: "添加验证好友，请求失败", url: r.API_webwxverifyuser, params: i, res: e})
                }), n.promise
                ...
                n.ContactFlag = o ? n.ContactFlag | r.CONTACTFLAG_TOPCONTACT : n.ContactFlag & ~r.CONTACTFLAG_TOPCONTACT, e.$broadcast("contact:settop", n), u({
                    ...
                    data: angular.extend({UserName: t, CmdId: r.oplogCmdId.TOPCONTACT, OP: o ? 1 : 0}, a.getBaseRequest()),
                    MMRetry: {count: 3, timeout: 1e4, serial: !0}
                }).success(function () {
                }).error(function () {
                })
    ...
    angular.module("Services").factory("loginFactory", ["$http", "$q", "$timeout", "accountFactory", "confFactory", "utilFactory", "mmHttp", "reportService", function (e, t, o, n, r, a, i, c) {
        var s = {
            getUUID: function () {
                ...
                var n = t.defer(), o = o || 0;
                return window.code = 0, $.ajax({url: r.API_login + "?loginicon=true&uuid=" + e + "&tip=" + o + "&r=" + ~new Date, dataType: "script", timeout: 35e3}).done(function () {
                ...
                var o = t.defer();
                return i({method: "GET", url: e + "&fun=new&version=v2", MMRetry: {count: 3, timeout: 1e4, serial: !0}}).success(function (e) {
    ...
    angular.module("Services").factory("utilFactory", ["$q", "$rootScope", "confFactory", function (e, t, o) {
        ...
        var u = {
            isLog: !1, log: function () {
                ...
                if (null != t.match(/trident/))e = {browser: "msie", version: null != t.match(/msie ([\d.]+)/) ? t.match(/msie ([\d.]+)/)[1] : t.match(/rv:([\d.]+)/)[1]}; else {
            ...
            }, fitRun: n, findIndex: function (e, t) {
            ...
            }, isWindows: /windows/gi.test(navigator.userAgent), isMacOS: /macintosh/gi.test(navigator.userAgent), isIPad: /ipad/gi.test(navigator.userAgent)
        };
        return u
    }])
}(), !function () {
            ...
            i.StopUpload(), i.ClearHeaders(), i.ClearFormItems(), i && (i.URL = (MMDEV ? "http://wx.qq.com" : "http://" + location.hostname) + e.API_webwxpreview + "?fun=upload", i.AddHeader("Cookie", document.cookie), i.AddFormItem("msgimgrequest", 0, 0, o), i.AddFormItem("filename", 1, 4, a()), i.OnEvent = function (e, o) {
                switch (o) {
                    ...
                    case 3:
                        ...
                        break;
                    case 1:
                        console.error("screensnap upload error"), t.report(t.ReportType.uploaderError, {text: "screensnap upload error", url: i.URL}), r({}), i = null
                }
            }, i.StartUpload())
        }
    ...
    angular.module("Services").factory("notificationFactory", ["utilFactory", function (e) {
        ...
        var s = "default", l = "granted", u = "denied", f = [l, s, u], d = {pageVisibility: !1, autoClose: 5e3, total: 3}, g = "", m = function () {
            var t = !1;
            try {
    ...
    angular.module("Services").factory("oplogFactory", ["$http", "accountFactory", "confFactory", function (e, t, o) {
        return {
            feedback: function (n) {
                e({method: "POST", url: o.API_webwxfeedback, data: angular.extend(t.getBaseRequest(), {MachineType: "webwx", Content: n, ReportType: 0})})
            }
        }
    }])
}(), !function () {
    ...
    angular.module("Services").factory("reportService", ["$http", "$rootScope", "confFactory", "accountFactory", function (e, t, o, n) {
        ...
        function a(e) {
            e.needSend ? (p({Type: 1, Text: JSON.stringify({type: T.timing, data: r()})}, !0), P = !0, f()) : e.fullTiming ? p({
                Type: 1,
        ...
        function d() {
            $(window).unload(function () {
                w.unload = m(t), v.push({type: T.runtime, data: w}), !P && v.push({type: T.timing, data: {fullTiming: r()}}), localStorage.setItem(S, JSON.stringify(v))
            })
        }
        ...
        function M(t) {
            e({method: "POST", url: o.API_webwxreport + "?fun=new", data: {BaseRequest: {Uin: n.getUin(), Sid: n.getSid()}, Count: t.length, List: t}}).success(function (e) {
                console.log(e)
            }).error(function (e) {
                console.log(e)
            })
        ...
        var p = a.find("body"), h = {
            ...
            open: function (l) {
                ...
                return S = y.container ? y.container : p, c(w)(v), m.enter(w, S), y.autoFoucs && w.focus(), y.controller && (angular.isString(y.controller) || angular.isArray(y.controller) || angular.isFunction(y.controller)) && g(y.controller, {
                    ...
                    close: v.closeThisMmPop, isOpen: function () {
    ...
    angular.module("Directives").directive("miniUserProfileDirective", ["$timeout", "confFactory", function () {
        return {
            restrict: "A", templateUrl: "miniUserProfile.html", scope: {user: "=", showOrderc: "=", hasCheckbox: "=", selectedUsers: "=", clickUserCallback: "="}, link: function () {
            }
        }
    ...
    angular.module("Directives").directive("contactListDirective", ["$timeout", "confFactory", function () {
        return {
            ...
            replace: !0,
            scope: {currentContact: "=", starContacts: "=", chatroomContacts: "=", friendContacts: "=", clickUserCallback: "=", allContacts: "=", dblclickCallback: "=", heightCalc: "=?"},
            link: function (e) {
        ...
        return {
            ...
            replace: !0,
            scope: {starContacts: "=", chatroomContacts: "=", friendContacts: "=", selectedUsers: "=", isCheck: "=", allContacts: "=", clickUserCallback: "="},
            link: function (e) {
    ...
    angular.module("Directives").directive("contactItemDirective", ["$timeout", "confFactory", function () {
        return {
            restrict: "A", templateUrl: "contactItem.html", replace: !0, scope: {className: "@", user: "=", showOrderSymbol: "=", orderSymbol: "=", clickUserCallback: "="}, link: function () {
            }
        }
    }]).directive("contactItemChooserDirective", ["$timeout", "confFactory", function () {
        return {
            restrict: "A", templateUrl: "contactItemChooser.html", scope: {user: "=", showOrderSymbol: "=", orderSymbol: "=", isCheck: "=", clickUserCallback: "="}, link: function () {
            }
        }
    }])
}(), !function () {
    ...
    angular.module("Directives").directive("contextMenuDirective", ["$timeout", "$document", "confFactory", function () {
        return {
            restrict: "A", templateUrl: "contextMenu.html", replace: !0, scope: {}, controller: "contextMenuController", link: function () {
            }
        }
    }])
}(), !function (e, t) {
    ...
    return {
        restrict: "EA", templateUrl: "preview.html", scope: {imageList: "=", current: "="}, link: function (n, r) {
            ...
            function f() {
                ...
                var t = new Image;
                t.onload = function () {
                    t.onload = null, M = {width: t.width, height: t.height}, y = {width: M.width, height: M.height, top: (h - M.height) / 2, left: (p - M.width) / 2, scale: 1};
            ...
            n.isLoaded = !1, n.rotateDeg = 0, n.isIE = !!(o.browser.msie && o.version < 10), n.actions = {
                next: function () {
                    ...
                    n.rotateDeg = (n.rotateDeg + 90) % 360, c({scale: E.scale}), s({top: (h - y.height) / 2, left: (p - y.width) / 2}), n.reflowFlag = !n.reflowFlag
                }, close: function () {
                    r.remove(), n.$destroy()
                }
            }, n.$on("$destroy", function () {
                ...
                open: function (a) {
                    ...
                    return g.when(c(w.template || w.templateUrl)).then(function (t) {
                        ...
                        if (E.closeThisDialog = function (e) {
                                ...
                                t > 0 && _.setBodyPadding(t), T.append(b), w.name ? p.$broadcast("ngDialog.opened", {dialog: b, name: w.name}) : p.$broadcast("ngDialog.opened", b)
    ...
    function o(e, t, o, n, r) {
        ...
        if (o > n) {
            for (var s = t; s > -1; s--)if (a = e[s], i = c, c += a._h || (a._h = r(a)), n > o - c)return {index: s, total: i};
            return {index: 0, total: 0}
        }
        for (var s = t; s < e.length; s++)if (a = e[s], i = c, c += a._h || (a._h = r(a)), o + c > n)return {index: s, total: i};
    ...
    return {
        restrict: "EA", priority: 1e3, scope: !0, terminal: !0, link: function (e, o, n) {
            ...
            o.html(""), o.append(m), e.bufferHeight || (e.bufferHeight = 100), e.preCalc = n.preCalc && "false" !== n.preCalc ? !0 : !1, e[d] = [],
        ...
        restrict: "EA", scope: !0, templateUrl: "navContact.html", link: function (c) {
            ...
            function u() {
                c.currentContact = n.getCurrentContact(), c.allContacts = n.pickContacts(["star", "chatroom", "friend"], {
                    friend: {isWithoutStar: !0, isWithoutBrand: !0},
                    chatroom: {isSaved: !0}
                }).result
            }
    ...
    return {
        restrict: "EA", scope: {selectList: "=", pickConfig: "=", initList: "="}, templateUrl: "contactPicker.html", link: function (t, o) {
            function n(e) {
                var o = -1;
            ...
            t.contactList = r(c.pickContacts(p.types, p.opt, !0).result, h), t.selectList = t.selectList || [], i(), t.search = function () {
                g && e.cancel(g), g = e(function () {
                    if (t.keyword) {
                        ...
                        var e = $.extend(d(t.selectList), p.opt.all.filterContacts), o = $.extend({}, p.opt, {all: $.extend({}, p.opt.all, {noHeader: !0, keyword: t.keyword, filterContacts: e})});
    ...
    return o.on("resize", function () {
        t.fitRun("resize", function () {
            ...
            n != t && i.push(c), r != a && i.push(s), i.length > 0 && e.addRecord({action: i.join(" "), type: "resize"}), n = t, r = a
        }, 200, 500)
    }), {
            ...
            for (var a in r) {
                ...
                if ("keydown" == i) {
                    ...
                    o.on("keydown", function (t) {
                        for (var o in c)s[c[o]] == t.keyCode && e.addRecord({type: "keydown", action: n.target + "-" + c[o]})
                    })
                }
                if ("click" == i) {
                    var l;
    ...
    t.module("ngClipboard", []).provider("ngClip", function () {
        ...
        return {
            scope: {clipCopy: "&", clipClick: "&", clipClickFallback: "&"}, restrict: "A", link: function (e, o, n) {
    ...
    angular.module("webwxApp", ["ui.router", "ngAnimate", "Services", "Controllers", "Directives", "Filters", "ngDialog", "jQueryScrollbar", "ngClipboard", "exceptionOverride"]).run(["$rootScope", "$state", "$stateParams", function (e, t, o) {
        ...
        n.state("chat", {
                ...
                navView: {
                    controller: ["$stateParams", "chatFactory", "contactFactory", "stateManageService", "$rootScope", function (e, t, o, n, r) {
                        ...
                        if (n.change("navChat:active", !0), e.userName) {
                            ...
                            i ? a() : o.addBatchgetContact({UserName: e.userName, ChatRoomId: ""}, !0).then(function (e) {
            ...
            url: "", params: {readItem: ""}, views: {
                navView: {
                    controller: ["stateManageService", function (e) {
                        e.change("navRead:active", !0)
                    }]
                }, contentView: {
                    templateUrl: "contentRead.html", controller: ["$scope", "$stateParams", "subscribeMsgService", "mmpop", function (e, t, o, n) {
