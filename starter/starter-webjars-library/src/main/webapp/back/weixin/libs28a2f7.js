...
!function (e) {
    ...
    if (!require) {
        var r = document.getElementsByTagName("head")[0], i = {}, o = {}, a = {}, s = {}, u = {}, l = {};
        define = function (e, t) {
...
}(this), define("jquery.js", function (e, t, n) {
    !function (e, t) {
        ...
        function c(e, t, n, r) {
            if (it.acceptData(e)) {
                ...
                if (l && u[l] && (r || u[l].data) || void 0 !== n || "string" != typeof t)return l || (l = s ? e[a] = X.pop() || it.guid++ : a), u[l] || (u[l] = s ? {} : {toJSON: it.noop}), ("object" == typeof t || "function" == typeof t) && (r ? u[l] = it.extend(u[l], t) : u[l].data = it.extend(u[l].data, t)), o = u[l], r || (o.data || (o.data = {}), o = o.data), void 0 !== n && (o[it.camelCase(t)] = n), "string" == typeof t ? (i = o[t], null == i && (i = o[it.camelCase(t)])) : i = o, i
            }
        }
        ...
        function R(e, t, n) {
            var r, i, o, a, s, u, l, c, f = this, d = {}, p = e.style, h = e.nodeType && kt(e), v = it._data(e, "fxshow");
            ...
            if (it.isEmptyObject(d))"inline" === ("none" === l ? T(e.nodeName) : l) && (p.display = l); else {
        ...
        function q(e, t, n) {
            var r, i, o = 0, a = $n.length, s = it.Deferred().always(function () {
                delete u.elem
            }), u = function () {
                if (i)return !1;
        ...
        function B(e, t, n, r) {
            ...
            }); else if (n || "object" !== it.type(t))r(e, t); else for (i in t)B(e + "[" + i + "]", t[i], n, r)
        }
        ...
        var X = [], Y = X.slice, J = X.concat, G = X.push, K = X.indexOf, Z = {}, et = Z.toString, tt = Z.hasOwnProperty, nt = {}, rt = "1.11.2", it = function (e, t) {
        ...
        var lt = function (e) {
            ...
            function m(e, t, n, i, o, a) {
                return i && !i[I] && (i = m(i)), o && !o[I] && (o = m(o, a)), r(function (r, a, s, u) {
                    var l, c, f, d = [], p = [], h = a.length, m = r || v(t || "*", s.nodeType ? [s] : s, []), y = !e || !r && t ? m : g(m, d, e, s, u), $ = n ? o || (r ? e : h || i) ? [] : a : y;
            ...
            function y(e) {
                for (var t, n, r, i = e.length, o = x.relative[e[0].type], a = o || x.relative[" "], s = o ? 1 : 0, u = p(function (e) {
                    ...
                    if (n = x.filter[e[s].type].apply(null, e[s].matches), n[I]) {
                        ...
                        return m(s > 1 && h(c), s > 1 && d(e.slice(0, s - 1).concat({value: " " === e[s - 2].type ? "*" : ""})).replace(ut, "$1"), n, r > s && y(e.slice(s, r)), i > r && y(e = e.slice(r)), i > r && d(e))
                    }
                    c.push(n)
                }
                return h(c)
            ...
            function $(e, n) {
                var i = n.length > 0, o = e.length > 0, a = function (r, a, s, u, l) {
                    var c, f, d, p = 0, h = "0", v = r && [], m = [], y = k, $ = r || o && x.find.TAG("*", l), b = H += null == y ? 1 : Math.random() || .1, w = $.length;
            ...
            var b, w, x, C, S, T, E, A, k, N, _, D, M, O, P, j, R, L, q, I = "sizzle" + 1 * new Date, F = e.document, H = 0, V = 0, W = n(), B = n(), z = n(), U = function (e, t) {
                return e === t && (_ = !0), 0
            ...
            }, vt = /^(?:input|select|textarea|button)$/i, gt = /^h\d$/i, mt = /^[^{]+\{\s*\[native \w/, yt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, $t = /[+~]/, bt = /'|\\/g, wt = new RegExp("\\\\([\\da-f]{1,6}" + nt + "?|(" + nt + ")|.)", "ig"), xt = function (e, t, n) {
                var r = "0x" + t - 65536;
            ...
            w = t.support = {}, S = t.isXML = function (e) {
                ...
                }), j = j.length && new RegExp(j.join("|")), R = R.length && new RegExp(R.join("|")), t = mt.test(O.compareDocumentPosition), q = t || mt.test(O.contains) ? function (e, t) {
                ...
                var n = x.attrHandle[t.toLowerCase()], r = n && X.call(x.attrHandle, t.toLowerCase()) ? n(e, t, !P) : void 0;
                ...
                filter: {
                    TAG: function (e) {
                        ...
                        return 1 === r && 0 === i ? function (e) {
                            ...
                            var l, c, f, d, p, h, v = o !== a ? "nextSibling" : "previousSibling", g = t.parentNode, m = s && t.nodeName.toLowerCase(), y = !u && !s;
                            if (g) {
                                if (o) {
                                    for (; v;) {
                                ...
                                } else if (y && (l = (t[I] || (t[I] = {}))[e]) && l[0] === H)d = l[1]; else for (; (f = ++p && f && f[v] || (d = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== m : 1 !== f.nodeType) || !++d || (y && ((f[I] || (f[I] = {}))[e] = [H, d]), f !== t)););
            ...
            return f.prototype = x.filters = x.pseudos, x.setFilters = new f, T = t.tokenize = function (e, n) {
                ...
                for (s = e, u = [], l = x.preFilter; s;) {
                    ...
                    for (a in x.filter)!(i = ht[a].exec(s)) || l[a] && !(i = l[a](i)) || (r = i.shift(), o.push({value: r, type: a, matches: i}), s = s.slice(r.length));
                    if (!r)break
                }
        ...
        var pt, ht = e.document, vt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, gt = it.fn.init = function (e, t) {
            var n, r;
            if (!e)return this;
            if ("string" == typeof e) {
        ...
        var Et = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, At = ["Top", "Right", "Bottom", "Left"], kt = function (e, t) {
        ...
        var Dt = /^(?:input|select|textarea)$/i, Mt = /^key/, Ot = /^(?:mouse|pointer|contextmenu)|click/, Pt = /^(?:focusinfocus|focusoutblur)$/, jt = /^([^.]*)(?:\.(.+)|)$/;
        it.event = {
            global: {},
        ...
        var Rt = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", Lt = / jQuery\d+="(?:null|\d+)"/g, qt = new RegExp("<(?:" + Rt + ")[\\s/>]", "i"), It = /^\s+/, Ft = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Ht = /<([\w:]+)/, Vt = /<tbody/i, Wt = /<|&#?\w+;/, Bt = /<(?:script|style|link)/i, zt = /checked\s*(?:[^=]|=\s*.checked.)/i, Ut = /^$|\/(?:java|ecma)script/i, Qt = /^true\/(.*)/, Xt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Yt = {
        ...
        }, Jt = v(ht), Gt = Jt.appendChild(ht.createElement("div"));
        Yt.optgroup = Yt.option, Yt.tbody = Yt.tfoot = Yt.colgroup = Yt.caption = Yt.thead, Yt.th = Yt.td, it.extend({
            clone: function (e, t, n) {
                ...
                if (t)if (n)for (s = s || g(e), r = r || g(o), a = 0; null != (i = s[a]); a++)x(i, r[a]); else x(e, o);
                return r = g(o, "script"), r.length > 0 && w(r, !u && g(e, "script")), r = s = i = null, o
            }, buildFragment: function (e, t, n, r) {
                for (var i, o, a, s, u, l, c, f = e.length, d = v(t), p = [], h = 0; f > h; h++)if (o = e[h], o || 0 === o)if ("object" === it.type(o))it.merge(p, o.nodeType ? [o] : o); else if (Wt.test(o)) {
        ...
        var hn, vn, gn = /^(?:toggle|show|hide)$/, mn = new RegExp("^(?:([+-])=|)(" + Et + ")([a-z%]*)$", "i"), yn = /queueHooks$/, $n = [R], bn = {
            "*": [function (e, t) {
                var n = this.createTween(e, t), r = n.cur(), i = mn.exec(t), o = i && i[3] || (it.cssNumber[e] ? "" : "px"), a = (it.cssNumber[e] || "px" !== o && +r) && mn.exec(it.css(n.elem, e)), s = 1, u = 20;
                if (a && a[3] !== o) {
                    o = o || a[3], i = i || [], a = +r || 1;
        ...
        }), it.each({slideDown: P("show"), slideUp: P("hide"), slideToggle: P("toggle"), fadeIn: {opacity: "show"}, fadeOut: {opacity: "hide"}, fadeToggle: {opacity: "toggle"}}, function (e, t) {
        ...
        var xn, Cn, Sn = it.expr.attrHandle, Tn = /^(?:checked|selected)$/i, En = nt.getSetAttribute, An = nt.input;
        it.fn.extend({
            attr: function (e, t) {
        ...
        var kn = /^(?:input|select|textarea|button|object)$/i, Nn = /^(?:a|area)$/i;
        it.fn.extend({
            prop: function (e, t) {
        ...
        it.fn.extend({
            addClass: function (e) {
                ...
                return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(it.isFunction(e) ? function (n) {
                    ...
                    if ("string" === n)for (var t, r = 0, i = it(this), o = e.match($t) || []; t = o[r++];)i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else(n === Ct || "boolean" === n) && (this.className && it._data(this, "__className__", this.className), this.className = this.className || e === !1 ? "" : it._data(this, "__className__") || "")
                })
            }, hasClass: function (e) {
        ...
        var Pn, jn, Rn = /#.*$/, Ln = /([?&])_=[^&]*/, qn = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, In = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Fn = /^(?:GET|HEAD)$/, Hn = /^\/\//, Vn = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Wn = {}, Bn = {}, zn = "*/".concat("*");
        try {
            jn = location.href
        } catch (Un) {
        ...
        Pn = Vn.exec(jn.toLowerCase()) || [], it.extend({
            ...
            ajax: function (e, t) {
                ...
                var r, i, o, a, s, u, l, c, f = it.ajaxSetup({}, t), d = f.context || f, p = f.context && (d.nodeType || d.jquery) ? it(d) : it.event, h = it.Deferred(), v = it.Callbacks("once memory"), g = f.statusCode || {}, m = {}, y = {}, $ = 0, b = "canceled", w = {
                    readyState: 0,
                    ...
                    statusCode: function (e) {
                        var t;
                        if (e)if (2 > $)for (t in e)g[t] = [g[t], e[t]]; else w.always(e[w.status]);
                        return this
                    },
                    abort: function (e) {
                        var t = e || b;
...
}), window.$ = window.jQuery = require("jquery.js"), !function (e, t, n) {
    "use strict";
    function r(e) {
        return function () {
    ...
    function o(e, t, n) {
        var r;
        if (e)if (C(e))for (r in e)"prototype" == r || "length" == r || "name" == r || e.hasOwnProperty && !e.hasOwnProperty(r) || t.call(n, e[r], r); else if (Dr(e) || i(e))for (r = 0; r < e.length; r++)t.call(n, e[r], r); else if (e.forEach && e.forEach !== o)e.forEach(t, n); else for (r in e)e.hasOwnProperty(r) && t.call(n, e[r], r);
        return e
    }
    ...
    function z(e) {
        ...
        var n = 3, r = wr("<div>").append(e).html();
        try {
    ...
    function st(t) {
        ...
        Cr("ng", ["ngLocale"], ["$provide", function (e) {
            e.provider({$$sanitizeUri: Dn}), e.provider("$compile", Ft).directive({
                a: Mi,
                input: Wi,
                textarea: Wi,
                form: Ri,
                ...
                ngRequired: Gi,
                ngValue: eo
            }).directive({ngInclude: ho}).directive(Oi).directive(lo), e.provider({
                $anchorScroll: Pt,
                $animate: ri,
                $browser: Lt,
                $cacheFactory: qt,
    ...
    function ct(e, t, n, r) {
        function i(e) {
            var i, a, s, u, l, c, f, d = n && e ? [this.filter(e)] : [this], p = t;
    ...
    function $t(e, t, n) {
        var r = e.ng339, i = Rr[r || -1];
        return y(n) ? (i || (e.ng339 = r = ut(), i = Rr[r] = {}), void(i[t] = n)) : i && i[t]
    }

    function bt(e, t, n) {
        var r = $t(e, "data"), i = y(n), o = !i && y(t), a = o && !$(t);
        if (r || a || $t(e, "data", r = {}), i)r[t] = n; else {
            if (!o)return r;
            if (a)return r && r[t];
            f(r, t)
        }
    ...
    function Ot(e) {
        ...
        function f(e, t) {
            ...
            return {
                invoke: r, instantiate: i, get: n, annotate: Mt, has: function (t) {
                    return y.hasOwnProperty(t + p) || e.hasOwnProperty(t)
                }
            }
        }

        var d = {}, p = "Provider", v = [], m = new Dt([], !0), y = {
            $provide: {
                provider: t(n),
                factory: t(r),
                service: t(i),
    ...
    function Rt(e, t, r, i) {
        ...
        var l = this, c = t[0], f = e.location, d = e.history, p = e.setTimeout, v = e.clearTimeout, g = {};
        l.isMock = !1;
        var y = 0, $ = [];
        ...
        var C = f.href, S = t.find("base"), T = null;
        l.url = function (t, n) {
    ...
    function Ft(e, r) {
        var i = {}, a = "Directive", s = /^\s*directive\:\s*([\d\w_\-]+)\s+(.*)$/, l = /(([\d\w_\-]+)(?:\:([^;]+))?;?)/, c = /^(on[a-z]+|formaction)$/;
        this.directive = function d(t, n) {
            ...
            function k(e, t, r, i, o, a) {
                function s(e, r, i, o) {
                    var a, s, u, l, c, f, d, p, v = r.length, g = new Array(v);
            ...
            function O(e, i, a, s, l, c, f, d, p) {
                function h(e, t, n, r) {
                    e && (n && (e = M(e, n, r)), e.require = x.require, e.directiveName = S, (H === x || x.$$isolateScope) && (e = X(e, {isolateScope: !0})), f.push(e)), t && (n && (t = M(t, n, r)), t.require = x.require, t.directiveName = S, (H === x || x.$$isolateScope) && (t = X(t, {isolateScope: !0})), d.push(t))
                }
                ...
                function y(e, t, s, l, c) {
                    ...
                    for (S = c && p, j && o(j, function (e) {
                        var n, r = {$scope: e === H || e.$$isolateScope ? C : t, $element: y, $attrs: h, $transclude: S};
                ...
                for (var w, x, S, T, k, N, O = -Number.MAX_VALUE, j = p.controllerDirectives, H = p.newIsolateScopeDirective, W = p.templateDirective, B = p.nonTlbTranscludeDirective, U = !1, J = !1, G = p.hasElementTranscludeDirective, Z = a.$$element = wr(i), et = c, tt = s, nt = 0, rt = e.length; rt > nt; nt++) {
                    ...
                    if ((N = x.scope) && (w = w || x, x.templateUrl || (V("new/isolated scope", H, x, Z), $(N) && (H = x))), S = x.name, !x.templateUrl && x.controller && (N = x.controller, j = j || {}, V("'" + S + "' controller", j[S], x, Z), j[S] = x), (N = x.transclude) && (U = !0, x.$$tlb || (V("transclusion", B, x, Z), B = x), "element" == N ? (G = !0, O = x.priority, T = Z, Z = a.$$element = wr(t.createComment(" " + S + ": " + a[S] + " ")), i = Z[0], Q(l, I(T), i), tt = E(T, s, O, et && et.name, {nonTlbTranscludeDirective: B})) : (T = wr(vt(i)).contents(), Z.empty(), tt = E(T, s))), x.template)if (J = !0, V("template", W, x, Z), W = x, N = C(x.template) ? x.template(Z, a) : x.template, N = K(N), x.replace) {
                        ...
                        Q(l, Z, i);
                        var at = {$attr: {}}, st = _(i, [], at), ut = e.splice(nt + 1, e.length - (nt + 1));
                    ...
                    }), rt = e.length; else if (x.compile)try {
            ...
            function j(t, r, o, s, l, c, f) {
                ...
                if (i.hasOwnProperty(r))for (var h, v = e.get(r + a), g = 0, m = v.length; m > g; g++)try {
                    h = v[g], (s === n || s > h.priority) && -1 != h.restrict.indexOf(o) && (c && (h = p(h, {$$start: c, $$end: f})), t.push(h), d = h)
                } catch (y) {
                    u(y)
                }
                return d
            ...
            function F(e, t, n, r, i, a, s, u) {
                var l, c, p = [], v = t[0], g = e.shift(), m = f({}, g, {
                    templateUrl: null,
                    transclude: null,
                    replace: null,
                    $$originalDirective: g
                }), y = C(g.templateUrl) ? g.templateUrl(t, n) : g.templateUrl;
                return t.empty(), d.get(x.getTrustedResourceUrl(y), {cache: h}).success(function (f) {
                    var d, h, b, w;
                    if (f = K(f), g.replace) {
                    ...
                    for (e.unshift(m), l = O(e, d, n, i, t, g, a, s, u), o(r, function (e, n) {
                        ...
                        var C = p.shift(), S = p.shift(), T = p.shift(), E = p.shift(), D = t[0];
                        if (S !== v) {
                            var M = S.className;
            ...
            var J = r.startSymbol(), G = r.endSymbol(), K = "{{" == J || "}}" == G ? v : function (e) {
    ...
    function Jt() {
        var e = /^\s*(\[|\{[^\{])/, t = /[\}\]]\s*$/, r = /^\)\]\}',?\n/, i = {"Content-Type": "application/json;charset=utf-8"}, a = this.defaults = {
            ...
            }], headers: {common: {Accept: "application/json, text/plain, */*"}, post: R(i), put: R(i), patch: R(i)}, xsrfCookieName: "XSRF-TOKEN", xsrfHeaderName: "X-XSRF-TOKEN"
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (e, t, r, i, c, d) {
            function p(e) {
                function t(e) {
                    var t = f({}, e, {data: Xt(e.data, e.headers, i.transformResponse)});
                ...
                var i = {method: "get", transformRequest: a.transformRequest, transformResponse: a.transformResponse}, s = r(e);
            ...
            function g(r, o, s) {
                ...
                function l(e, t, n, i) {
                    t = Math.max(t, 0), (Yt(t) ? v.resolve : v.reject)({data: e, status: t, headers: Qt(n), config: r, statusText: i})
                }

                function f() {
                    var e = O(p.pendingRequests, r);
                    -1 !== e && p.pendingRequests.splice(e, 1)
                }

                var d, h, v = c.defer(), g = v.promise, b = w(r.url, r.params);
    ...
    function Zt(e, t, n, r, i) {
        ...
        return function (i, u, l, c, f, d, p, v) {
            ...
            if (d > 0)var S = n(g, d); else N(d) && d.then(g)
        }
    }
                ...
                return !u || m ? (y.length = g, d = function (e) {
                    try {
                        for (var t, n = 0, a = g; a > n; n++) {
                            if ("function" == typeof(t = v[n]))if (t = t(e), t = l ? i.getTrusted(l, t) : i.valueOf(t), null == t)t = ""; else switch (typeof t) {
                                case"string":
                                    break;
                                case"number":
                                    t = "" + t;
    ...
    function tn() {
        this.$get = ["$rootScope", "$window", "$q", function (e, t, n) {
            function r(r, o, a, s) {
                var u = t.setInterval, l = t.clearInterval, c = n.defer(), f = c.promise, d = 0, p = y(s) && !s;
    ...
    function fn(e, t) {
        ...
        on(e, this, e), this.$$parse = function (t) {
            ...
            var e = X(this.$$search), t = this.$$hash ? "#" + Y(this.$$hash) : "";
    ...
    function wn(e, t, r, i, o) {
        ...
        for (var a, s = t.split("."), u = 0; s.length > 1; u++) {
            a = yn(s.shift(), i);
            var l = $n(e[a], i);
            l || (l = {}, e[a] = l), e = l, e.then && o.unwrapPromises && (ci(i), "$$v" in e || !function (e) {
                e.then(function (t) {
                    e.$$v = t
                })
            }(e), e.$$v === n && (e.$$v = {}), e = e.$$v)
    ...
    function Cn(e, t, r, i, o, a, s) {
        ...
        var u = function (e) {
            return $n(e, a)
        }, l = s.expensiveChecks, c = l || xn(e) ? u : v, f = l || xn(t) ? u : v, d = l || xn(r) ? u : v, p = l || xn(i) ? u : v, h = l || xn(o) ? u : v;
    ...
    function Tn(e, t, r) {
        var i = t.expensiveChecks, a = i ? wi : bi;
        if (a.hasOwnProperty(e))return a[e];
        var s, u = e.split("."), l = u.length;
        if (t.csp)s = 6 > l ? Cn(u[0], u[1], u[2], u[3], u[4], r, t) : function (e, i) {
            var o, a = 0;
            do o = Cn(u[a++], u[a++], u[a++], u[a++], u[a++], r, t)(e, i), i = n, e = o; while (l > a);
            return o
        }; else {
            var c = "var p;\n";
            i && (c += "s = eso(s, fe);\nl = eso(l, fe);\n");
            ...
            o(u, function (e, n) {
                yn(e, r);
                var o = (n ? "s" : '((l&&l.hasOwnProperty("' + e + '"))?l:s)') + '["' + e + '"]', a = i || xn(e);
    ...
    function En() {
        ...
        this.unwrapPromises = function (e) {
            ...
            n.csp = i.csp;
            var a = {csp: n.csp, unwrapPromises: n.unwrapPromises, logPromiseWarnings: n.logPromiseWarnings, expensiveChecks: !0};
            return ci = function (e) {
                ...
                switch (typeof i) {
                    case"string":
                        ...
                        var l = o ? a : n, c = new yi(l), f = new $i(c, r, l);
    ...
    function kn(e, t) {
        ...
        return {defer: s, reject: l, when: f, all: a}
    }
        ...
        this.digestTtl = function (t) {
            ...
            c.prototype = {
                constructor: c, $new: function (e) {
                    ...
                    var i = this, o = p(e, "watch"), a = i.$$watchers, s = {fn: t, last: g, get: o, exp: e, eq: !!r};
                    if (n = null, !C(t)) {
                    ...
                    var o, a, u, l = this, c = t.length > 1, f = 0, d = s(e), p = [], h = {}, v = !0, g = 0;
                    return this.$watch(n, r)
                }, $digest: function () {
                    var r, i, o, s, l, c, p, h, v, m, y, $ = this.$$asyncQueue, b = this.$$postDigestQueue, w = e, x = this, S = [];
    ...
    function jn() {
        ...
        this.resourceUrlWhitelist = function (t) {
            ...
            var f = a(), d = {};
            return d[Ci.HTML] = a(f), d[Ci.CSS] = a(f), d[Ci.URL] = a(f), d[Ci.JS] = a(f), d[Ci.RESOURCE_URL] = a(d[Ci.URL]), {trustAs: s, getTrusted: l, valueOf: u}
        }]
    }
    ...
    function Ln() {
        this.$get = ["$window", "$document", function (e, t) {
            var n, r, i = {}, o = d((/android (\d+)/.exec(vr((e.navigator || {}).userAgent)) || [])[1]), a = /Boxee/i.test((e.navigator || {}).userAgent), s = t[0] || {}, u = s.documentMode, l = /^(Moz|webkit|O|ms)(?=[A-Z])/, c = s.body && s.body.style, f = !1, p = !1;
            if (c) {
            ...
            return {
                history: !(!e.history || !e.history.pushState || 4 > o || a), hashchange: "onhashchange" in e && (!u || u > 7), hasEvent: function (e) {
                    ...
                    return i[e]
                }, csp: Or(), vendorPrefix: n, transitions: f, animations: p, android: o, msie: br, msieDocumentMode: u
            }
        }]
    }
    ...
    function qn() {
        this.$get = ["$rootScope", "$browser", "$q", "$exceptionHandler", function (e, t, n, r) {
            function i(i, a, s) {
                var u, l = n.defer(), c = l.promise, f = y(s) && !s;
    ...
    function Yn(e, t) {
        return function (n, r) {
            var i = n["get" + e](), o = mr(t ? "SHORT" + e : e);
            return r[o][i]
        }
    }
    ...
    function rr(e, t, n, r) {
        ...
        var a = this, s = e.parent().controller("form") || Pi, u = 0, l = a.$error = {}, c = [];
        a.$name = t.name || t.ngForm, a.$dirty = !1, a.$pristine = !0, a.$valid = !0, a.$invalid = !1, s.$addControl(a), e.addClass(Ui), i(!0), a.$addControl = function (e) {
            ...
            var r = l[e];
            if (t)r && (P(r, n), r.length || (u--, u || (i(t), a.$valid = !0, a.$invalid = !1), l[e] = !1, i(!0, e), s.$setValidity(e, !0, a))); else {
                if (u || i(t), r) {
                    if (M(r, n))return
    ...
    function sr(e, t, n, i, o, a) {
        var s = t.prop(hr), u = t[0].placeholder, l = {}, c = vr(t[0].type);
    ...
    var hr = "validity", vr = function (e) {
        return b(e) ? e.toLowerCase() : e
    }, gr = Object.prototype.hasOwnProperty, mr = function (e) {
    ...
    var br, wr, xr, Cr, Sr, Tr = [].slice, Er = [].push, Ar = Object.prototype.toString, kr = r("ng"), Nr = e.angular || (e.angular = {}), _r = ["0", "0", "0"];
    ...
    }, Pr = /[A-Z]/g, jr = {full: "1.2.28", major: 1, minor: 2, dot: 28, codeName: "finnish-disembarkation"};
    ht.expando = "ng339";
    var Rr = ht.cache = {}, Lr = 1, qr = e.document.addEventListener ? function (e, t, n) {
    ...
    o("input,select,option,textarea,button,form,details".split(","), function (e) {
        Jr[mr(e)] = !0
    }), o({data: bt, removeData: yt}, function (e, t) {
        ht[t] = e
    }), o({
        data: bt, inheritedData: Et, scope: function (e) {
            ...
            e.removeAttribute(t)
        }, hasClass: wt, css: function (e, t, r) {
            if (t = lt(t), !y(r)) {
                var i;
        ...
        ht.prototype[t] = function (t, r) {
            ...
            if (e !== At && (2 == e.length && e !== wt && e !== Tt ? t : r) === n) {
                if ($(t)) {
                    for (i = 0; a > i; i++)if (e === bt)e(this[i], t); else for (o in t)e(this[i], o, t[o]);
                    return this
                }
        ...
        }, addClass: Ct, removeClass: xt, toggleClass: function (e, t, n) {
        ...
        }, clone: vt, triggerHandler: function (e, t, n) {
            var r, i, a, s = t.type || t, u = ($t(e, "events") || {})[s];
            u && (r = {
                preventDefault: function () {
    ...
    var Gr = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, Kr = /,/, Zr = /^\s*(_?)(\S+?)\1\s*$/, ei = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, ti = r("$injector"), ni = r("$animate"), ri = ["$provide", function (e) {
    ...
    var oi = /^(x[\:\-_]|data[\:\-_])/i, ai = r("$interpolate"), si = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/, ui = {http: 80, https: 443, ftp: 21}, li = r("$location");
    pn.prototype = dn.prototype = fn.prototype = {
        $$html5: !1, $$replace: !1, absUrl: hn("$$absUrl"), url: function (e) {
            if (m(e))return this.$$url;
            var t = si.exec(e);
            return t[1] && this.path(decodeURIComponent(t[1])), (t[2] || t[1]) && this.search(t[3] || ""), this.hash(t[5] || ""), this
        }, protocol: hn("$$protocol"), host: hn("$$host"), port: hn("$$port"), path: vn("$$path", function (e) {
    ...
    var ci, fi = r("$parse"), di = {}, pi = Function.prototype.call, hi = Function.prototype.apply, vi = Function.prototype.bind, gi = {
        "null": function () {
            return null
        }, "true": function () {
            return !0
    ...
    }, mi = {n: "\n", f: "\f", r: "\r", t: "	", v: "", "'": "'", '"': '"'}, yi = function (e) {
        this.options = e
    };
    yi.prototype = {
        constructor: yi, lex: function (e) {
            for (this.text = e, this.index = 0, this.ch = n, this.lastCh = ":", this.tokens = []; this.index < this.text.length;) {
                if (this.ch = this.text.charAt(this.index), this.is("\"'"))this.readString(this.ch); else if (this.isNumber(this.ch) || this.is(".") && this.isNumber(this.peek()))this.readNumber(); else if (this.isIdent(this.ch))this.readIdent(); else if (this.is("(){}[].,;:?"))this.tokens.push({
                    ...
                    var t = this.ch + this.peek(), r = t + this.peek(2), i = gi[this.ch], o = gi[t], a = gi[r];
                    a ? (this.tokens.push({index: this.index, text: r, fn: a}), this.index += 3) : o ? (this.tokens.push({
                        index: this.index,
                        text: t,
                        fn: o
            ...
            if (gi.hasOwnProperty(o))s.fn = gi[o], s.literal = !0, s.constant = !0; else {
            ...
            for (var n = "", r = e, i = !1; this.index < this.text.length;) {
                ...
                if (r += o, i) {
                    ...
                    if (o === e)return this.index++, void this.tokens.push({
                        index: t, text: r, string: n, literal: !0, constant: !0, fn: function () {
                            return n
                        }
                    });
                    n += o
    ...
    $i.ZERO = f(function () {
        return 0
    }, {constant: !0}), $i.prototype = {
        constructor: $i, parse: function (e) {
            ...
            return this.consume("]"), f(function (i, o) {
                ...
                assign: function (n, i, o) {
                    var a = yn(r(n, o), t.text), s = $n(e(n, o), t.text);
    ...
    var bi = {}, wi = {}, xi = r("$sce"), Ci = {HTML: "html", CSS: "css", URL: "url", RESOURCE_URL: "resourceUrl", JS: "js"}, Si = t.createElement("a"), Ti = In(e.location.href, !0);
    ...
    var Ei = ".", Ai = {
        ...
        a: Gn,
        Z: Jn
    }, ki = /((?:[^yMdHhmsaZE']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z))(.*)/, Ni = /^\-?\d+$/;
    Kn.$inject = ["$locale"];
    var _i = g(vr), Di = g(mr);
    tr.$inject = ["$parse"];
    var Mi = g({
    ...
    var Pi = {$addControl: h, $removeControl: h, $setValidity: h, $setDirty: h, $setPristine: h};
    ...
    var ji = function (e) {
    ...
    }, Ri = ji(), Li = ji(!0), qi = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, Ii = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, Fi = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Hi = {
        text: sr,
        number: ur,
        url: lr,
        email: cr,
        ...
        reset: h,
        file: h
    }, Vi = ["badInput"], Wi = ["$browser", "$sniffer", function (e, t) {
        return {
            restrict: "E", require: "?ngModel", link: function (n, r, i, o) {
                o && (Hi[vr(i.type)] || Hi.text)(n, r, i, o, t, e)
            }
        }
    }], Bi = "ng-valid", zi = "ng-invalid", Ui = "ng-pristine", Qi = "ng-dirty", Xi = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", function (e, t, n, i, a, s) {
        function u(e, t) {
        ...
        var f = i.inheritedData("$formController") || Pi, d = 0, p = this.$error = {};
        ...
        return {
            require: ["ngModel", "^?form"], controller: Xi, link: function (e, t, n, r) {
                var i = r[0], o = r[1] || Pi;
    ...
    var fo = ["$animate", function (e) {
        return {
            transclude: "element", priority: 600, terminal: !0, restrict: "A", $$tlb: !0, link: function (n, r, i, o, a) {
                var s, u, l;
        ...
        return {
            restrict: "ECA", priority: 400, terminal: !0, transclude: "element", controller: Nr.noop, compile: function (o, a) {
                var s = a.ngInclude || a.src, u = a.onload || "", l = a.autoscroll;
                return function (o, a, c, f, d) {
                    var p, h, v, g = 0, m = function () {
    ...
    }), go = nr({terminal: !0, priority: 1e3}), mo = ["$locale", "$interpolate", function (e, t) {
        var n = /{}/g;
        return {
            restrict: "EA", link: function (r, i, a) {
                var s = a.count, u = a.$attr.when && i.attr(a.$attr.when), l = a.offset || 0, c = r.$eval(u) || {}, f = {}, d = t.startSymbol(), p = t.endSymbol(), h = /^when(Minus)?(.+)$/;
                o(a, function (e, t) {
        ...
        return {
            transclude: "element", priority: 1e3, terminal: !0, $$tlb: !0, link: function (r, c, f, d, p) {
                var h, v, g, m, y, $, b, w, x, C = f.ngRepeat, S = C.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/), T = {$id: _t};
                ...
                r.$watchCollection(b, function (e) {
                    var f, d, h, v, $, b, S, T, A, k, N, _, D = c[0], M = {}, O = [];
                    if (i(e))k = e, A = g || m; else {
                        A = g || y, k = [];
                        for (b in e)e.hasOwnProperty(b) && "$" != b.charAt(0) && k.push(b);
                        k.sort()
                    }
                    for (v = k.length, d = O.length = k.length, f = 0; d > f; f++)if (b = e === k ? f : k[f], S = e[b], T = A(b, S, f), rt(T, "`track by` id"), E.hasOwnProperty(T))N = E[T], delete E[T], M[T] = N, O[f] = N; else {
    ...
    }], Ao = r("ngOptions"), ko = g({terminal: !0}), No = ["$compile", "$parse", function (e, r) {
        var i = /^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/, s = {$setViewValue: h};
        return {
            restrict: "E", require: ["select", "?ngModel"], controller: ["$element", "$scope", "$attrs", function (e, t, n) {
                ...
                function p(t, o, s) {
                    ...
                    function l() {
                        var e, n, r, i, l, c, b, S, A, k, N, _, D, M, O, P = {"": []}, j = [""], R = s.$modelValue, L = m(t) || [], q = p ? a(L) : L, I = {}, F = u();
                        for (N = 0; A = q.length, A > N; N++) {
                            if (b = N, p) {
                                if (b = q[N], "$" === b.charAt(0))continue;
                                I[p] = b
                            }
                            if (I[d] = L[b], e = h(t, I) || "", (n = P[e]) || (n = P[e] = [], j.push(e)), $)_ = y(F.remove(T ? T(t, I) : g(t, I))); else {
                                if (T) {
                                    var H = {};
                                    H[d] = R, _ = T(t, H) === T(t, I)
                                } else _ = R === g(t, I);
                            ...
                            O = f(t, I), O = y(O) ? O : "", n.push({id: T ? T(t, I) : p ? q[N] : N, label: O, selected: _})
                        }
                        for ($ || (w || null === R ? P[""].unshift({id: "", label: "", selected: !F}) : F || P[""].unshift({id: "?", label: "", selected: !0})), k = 0, S = j.length; S > k; k++) {
                    ...
                    var f = r(c[2] || c[1]), d = c[4] || c[6], p = c[5], h = r(c[3] || ""), g = r(c[2] ? c[1] : d), m = r(c[7]), S = c[8], T = S ? r(c[8]) : null, E = [[{element: o, label: ""}]];
                    w && (e(w)(t), w.removeClass("ng-scope"), w.remove()), o.empty(), o.on("change", function () {
                        t.$apply(function () {
                            var e, r, i, a, u, c, f, h, v, y = m(t) || [], b = {};
                            if ($) {
                                for (i = [], c = 0, h = E.length; h > c; c++)for (e = E[c], u = 1, f = e.length; f > u; u++)if ((a = e[u].element)[0].selected) {
                                    if (r = a.val(), p && (b[p] = r), T)for (v = 0; v < y.length && (b[d] = y[v], T(t, b) != r); v++); else b[d] = y[r];
                                    i.push(g(t, b))
                                }
                            } else if (r = o.val(), "?" == r)i = n; else if ("" === r)i = null; else if (T) {
    ...
    t.module("ngAnimate", ["ng"]).directive("ngAnimateChildren", function () {
        ...
        var s = t.noop, u = t.forEach, l = i.$$selectors, c = 1, f = "$$ngAnimateState", d = "$$ngAnimateChildren", p = "ng-animate", h = {running: !0};
        r.decorator("$animate", ["$delegate", "$injector", "$sniffer", "$rootElement", "$$asyncCallback", "$rootScope", "$document", function (e, n, r, c, v, g) {
            ...
            function $(e, n, r) {
                function i(e, t) {
                    ...
                    return n || r ? ("leave" == t && (r = n, n = null), b.push({event: t, fn: n}), g.push({event: t, fn: r}), !0) : void 0
                }
                ...
                var a = e[0];
                if (a) {
                    var l, c, f = "setClass" == n, d = f || "addClass" == n || "removeClass" == n;
                    t.isArray(r) && (l = r[0], c = r[1], r = l + " " + c);
                    var p = e.attr("class") + " " + r;
                    if (E(p)) {
                        var h = s, v = [], g = [], m = s, $ = [], b = [], p = (" " + p).replace(/\s+/g, ".");
                        return u(y(p), function (e) {
                            !i(e, n) && f && (i(e, "addClass"), i(e, "removeClass"))
                        }), {
                            node: a, event: n, className: r, isClassBased: d, isSetClassOperation: f, before: function (e) {
                                h = e, o(g, v, function () {
                                    h = s, e()
                                })
                            }, after: function (e) {
            ...
            function b(e, n, r, i, o, a, s) {
                ...
                if (y) {
                    n = y.className;
                    var b = t.element._data(y.node), b = b && b.events;
                    i || (i = o ? o.parent() : r.parent());
                    var w = r.data(f) || {};
                    o = w.active || {};
                    var T, E = w.totalActive || 0, A = w.last;
                    if (y.isClassBased && (T = w.running || w.disabled || A && !A.isClassBased), T || C(r, i))g(), c(), d(), m(); else {
                        if (i = !1, E > 0) {
                            if (T = [], y.isClassBased)"setClass" == A.event ? (T.push(A), x(r, n)) : o[n] && (k = o[n], k.event == e ? i = !0 : (T.push(k), x(r, n))); else if ("leave" == e && o["ng-leave"])i = !0; else {
                        ...
                        if (!y.isClassBased || y.isSetClassOperation || i || (i = "addClass" == e == r.hasClass(n)), i)g(), c(), d(), h(); else {
                            ...
                            var N = S++;
                            E++, o[n] = y, r.data(f, {last: y, active: o, index: N, totalActive: E}), c(), y.before(function (t) {
                                var i = r.data(f);
            ...
            function x(e, t) {
                if (o(e) == o(c))h.disabled || (h.running = !1, h.structural = !1); else if (t) {
                    var n = e.data(f) || {}, r = !0 === t;
            ...
            var T = i.classNameFilter(), E = T ? function (e) {
                return T.test(e)
            } : function () {
                return !0
            };
            ...
            function m(e) {
                var t = e.parent(), n = t.data(I);
                return n || (t.data(I, ++U), n = U), n + "-" + o(e).getAttribute("class")
            }

            function y(e, t, n, r) {
                var i = m(t), a = i + " " + n, u = z[a] ? ++z[a].total : 0, l = {};
                if (u > 0) {
                    var c = n + "-stagger", l = i + " " + c;
                    (i = !z[l]) && t.addClass(c), l = v(t, l), i && t.removeClass(c)
                }
                r = r || function (e) {
                        return e()
                    }, t.addClass(n);
                var c = t.data(F) || {}, f = r(function () {
                    return v(t, a)
                });
            ...
            function x(e, t, n, r) {
                ...
                if (e = t.data(F), -1 != s.getAttribute("class").indexOf(n) && e) {
                    ...
                    var c = e.stagger, f = e.timings, d = e.itemIndex, h = Math.max(f.transitionDuration, f.animationDuration), v = Math.max(f.transitionDelay, f.animationDelay), g = v * B, m = Date.now(), y = M + " " + _, $ = "", b = [];
                    if (0 < f.transitionDuration) {
                        var w = f.transitionPropertyStyle;
                        -1 == w.indexOf("all") && ($ += O + "transition-property: " + w + ";", $ += O + "transition-duration: " + f.transitionDurationStyle + ";", b.push(O + "transition-property"), b.push(O + "transition-duration"))
                    }
            ...
            var P, j = "Duration", R = "Property", L = "Delay", q = "IterationCount", I = "$$ngAnimateKey", F = "$$ngAnimateCSS3Data", H = "ng-animate-block-transitions", V = 3, W = 1.5, B = 1e3, z = {}, U = 0, Q = [], X = null, Y = 0, J = [];
            return {
                enter: function (e, t) {
                    ...
                    var i = k(n, "-remove") + " " + k(t, "-add"), o = S("setClass", e, i, function (r) {
                        var i = e.attr("class");
    ...
    function h(e, t) {
        var r = 1, o = 2, u = {}, l = [], c = u, d = q(e.when(u), {$$promises: u, $$values: u});
        this.study = function (u) {
            ...
            return L(u, p), u = m = y = null, function (r, o, a) {
                ...
                var p = e.defer(), m = p.promise, y = m.$$promises = {}, $ = q({}, r), b = 1 + g.length / 3, w = !1;
    ...
    function v(e, t, n) {
        this.fromConfig = function (e, t, n) {
            ...
            return O(n) && (n = n(r)), null == n ? null : e.get(n, {cache: t, headers: {Accept: "text/html"}}).then(function (e) {
                return e.data
            })
    ...
    function g(e, t, i) {
        ...
        function s(n, i) {
            var o, a, s, u, l;
            return o = n[2] || n[3], l = t.params[o], s = e.substring(d, n.index), a = i ? n[4] : n[4] || ("*" == n[1] ? ".*" : null), u = F.type(a || "string") || r(F.type("string"), {pattern: new RegExp(a)}), {
                id: o,
                regexp: a,
                segment: s,
                type: u,
        ...
        t = q({params: {}}, j(t) ? t : {});
        var u, l = /([:*])([\w\[\]]+)|\{([\w\[\]]+)(?:\:((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, c = /([:]?)([\w\[\]-]+)|\{([\w\[\]-]+)(?:\:((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, f = "^", d = 0, p = this.segments = [], h = i ? i.params : {}, v = this.params = i ? i.params.$$new() : new F.ParamSet, g = [];
        this.source = e;
        for (var m, y, $; (u = l.exec(e)) && (m = s(u, !1), !(m.segment.indexOf("?") >= 0));)y = o(m.id, m.type, m.cfg, "path"), f += a(m.segment, y.type.pattern.source, y.squash), p.push(m.segment), d = l.lastIndex;
        $ = e.substring(d);
        var b = $.indexOf("?");
        if (b >= 0) {
    ...
    function y() {
        ...
        function u() {
            return {strict: $, caseInsensitive: v}
        }
        ...
        F = this;
        var h, v = !1, $ = !0, b = !1, w = {}, x = !0, C = [], S = {
            string: {encode: e, decode: i, is: o, pattern: /[^/]*/},
            "int": {
        ...
        y.$$getDefaultValue = function (e) {
            ...
            return w[e] = new m(q({name: e}, t)), n && (C.push({name: e, def: n}), x || c()), this
        }, L(S, function (e, t) {
            w[t] = new m(q({name: t}, e))
            ...
            function o(e) {
                var t = j(e) ? a(e) : [], n = -1 === s(t, "value") && -1 === s(t, "type") && -1 === s(t, "squash") && -1 === s(t, "array");
            ...
            function v(e, t, r, i) {
                ...
                return o = R(e.replace) ? e.replace : [], P(i) && o.push({from: i, to: n}), a = p(o, function (e) {
                    return e.from
                }), d(u, function (e) {
                    return -1 === s(a, e.from)
                }).concat(o)
            ...
            var S = r.value !== n, T = f(r, S), E = v(r, C, S, T);
            q(this, {id: e, type: t, location: i, array: C, squash: T, replace: E, isOptional: S, value: y, dynamic: n, config: r, toString: $})
        }, f.prototype = {
            $$new: function () {
                return r(this, q(new f, {$$parent: this}))
            }, $$keys: function () {
    ...
    function b(e, i) {
        ...
        function m(e) {
            var t = e.split("."), n = C.$current.name.split(".");
        ...
        function b(e, i, o, s, d, h, v) {
            ...
            function $(e, n, r, a, u, l) {
                var f = r ? n : c(e.params.$$keys(), n), p = {$stateParams: f};
            ...
            var b = i.reject(new Error("transition superseded")), T = i.reject(new Error("transition prevented")), A = i.reject(new Error("transition aborted")), k = i.reject(new Error("transition failed"));
            return x.locals = {resolve: null, globals: {$stateParams: {}}}, C = {params: {}, current: x.self, $current: x, transition: null}, C.reload = function () {
                return C.transitionTo(C.current, h, {reload: !0, inherit: !1, notify: !0})
            }, C.go = function (e, t, n) {
                return C.transitionTo(e, t, q({inherit: !0, relative: C.$current}, n))
            }, C.transitionTo = function (t, n, o) {
                n = n || {}, o = q({location: !0, inherit: !1, relative: null, notify: !0, reload: !1, $retry: !1}, o || {});
                var a, l = C.$current, d = C.params, p = l.path, g = f(t, o.relative);
                if (!M(g)) {
                    var m = {to: t, toParams: n, options: o}, S = y(m, l.self, d, o);
                    if (S)return S;
                ...
                var A = t.path, N = 0, _ = A[N], D = x.locals, O = [];
                ...
                r = q({lossy: !0, inherit: !0, absolute: !1, relative: C.$current}, r || {});
                var i = f(e, r.relative);
                if (!M(i))return null;
        ...
        var x, C, S = {}, T = {}, E = "abstract", A = {
            parent: function (e) {
                ...
                var t = {};
                return L(M(e.views) ? e.views : {"": e}, function (n, r) {
    ...
    function C(e, n, r, i) {
        ...
        var s = o(), u = s("$animator"), l = s("$animate"), c = {
            restrict: "ECA", terminal: !0, priority: 400, transclude: "element", compile: function (n, o, s) {
                return function (n, o, u) {
                    ...
                    function c(a) {
                        var c, f = T(n, u, o, i), y = f && e.$current && e.$current.locals[f];
                        if (a || y !== h) {
                    ...
                    var f, d, p, h, v = u.onload || "", g = u.autoscroll, m = a(u, n);
    ...
    function k(e, n) {
        ...
        return {
            restrict: "A", require: ["?^uiSrefActive", "?^uiSrefActiveEq"], link: function (i, o, a, s) {
                var u = E(a.uiSref, e.current.name), l = null, c = A(o) || e.$current, f = null, d = "A" === o.prop("tagName"), p = "FORM" === o[0].nodeName, h = p ? "action" : "href", v = !0, g = {
                    relative: c,
                    inherit: !0
    ...
    var M = t.isDefined, O = t.isFunction, P = t.isString, j = t.isObject, R = t.isArray, L = t.forEach, q = t.extend, I = t.copy;
    ...
    g.prototype.concat = function (e, t) {
        var n = {caseInsensitive: F.caseInsensitive(), strict: F.strictMode(), squash: F.defaultSquashPolicy()};
        ...
        for (o = 0; u > o; o++) {
            var c = s > o, f = r[o], d = i[f], h = d.value(e[f]), v = d.isOptional && d.type.equals(d.value(), h), g = v ? d.squash : !1, m = d.type.encode(h);
            if (c) {
                var y = n[o + 1];
                if (g === !1)null != m && (l += R(m) ? p(m, t).join("-") : encodeURIComponent(m)), l += y; else if (g === !0) {
                    var $ = l.match(/\/$/) ? /\/?(.*)/ : /(.*)/;
                    l += y.match($)[1]
                } else P(g) && (l += g + y)
            } else {
    ...
    }]), $.$inject = ["$locationProvider", "$urlMatcherFactoryProvider"], t.module("ui.router.router").provider("$urlRouter", $), b.$inject = ["$urlRouterProvider", "$urlMatcherFactoryProvider"], t.module("ui.router.state").value("$stateParams", {}).provider("$state", b), w.$inject = [], t.module("ui.router.state").provider("$view", w), t.module("ui.router.state").provider("$uiViewScroll", x), C.$inject = ["$state", "$injector", "$uiViewScroll", "$interpolate"], S.$inject = ["$compile", "$controller", "$state", "$interpolate"], t.module("ui.router.state").directive("uiView", C), t.module("ui.router.state").directive("uiView", S), k.$inject = ["$state", "$timeout"], N.$inject = ["$state", "$stateParams", "$interpolate"], t.module("ui.router.state").directive("uiSref", k).directive("uiSrefActive", N).directive("uiSrefActiveEq", N), _.$inject = ["$state"], D.$inject = ["$state"], t.module("ui.router.state").filter("isState", _).filter("includedByState", D)
        ...
        xml2json: function (t, n) {
            function r(t, a) {
                ...
                t.nodeType, i(t.localName || t.nodeName), t.text || t.nodeValue || "", t.childNodes && t.childNodes.length > 0 && e.each(t.childNodes, function (e, t) {
                    var n = t.nodeType, a = i(t.localName || t.nodeName), l = t.text || t.nodeValue || "";
                    if (8 != n)if (3 != n && 4 != n && a)u = u || {}, u[a] ? (u[a].length || (u[a] = o(u[a])), u[a] = o(u[a]), u[a][u[a].length] = r(t, !0), u[a].length = u[a].length) : u[a] = r(t); else {
                        if (l.match(/^\s+$/))return;
                        s += l.replace(/^\s+/, "").replace(/\s+$/, "")
                    }
                }), t.attributes && t.attributes.length > 0 && (l = {}, u = u || {}, e.each(t.attributes, function (e, t) {
                    var n = i(t.name), r = t.value;
            ...
            if ("string" == typeof t && (t = e.text2xml(t)), t.nodeType) {
                ...
                var a = 9 == t.nodeType ? t.documentElement : t, s = r(a, !0);
    ...
    "use strict";
    function r(t) {
        if (c.webkit && !t)return {height: 0, width: 0};
        if (!c.data.outer) {
            var n = {border: "none", "box-sizing": "content-box", height: "200px", margin: "0", padding: "0", width: "200px"};
    ...
    d.prototype = {
        destroy: function () {
            if (this.wrapper) {
                var n = this.container.scrollLeft(), r = this.container.scrollTop();
            ...
            var r = this, o = this.container, s = this.containerWrapper || o, f = e.extend(this.options, n || {}), d = {
                x: this.scrollx,
                y: this.scrolly
            }, p = this.wrapper, h = {scrollLeft: o.scrollLeft(), scrollTop: o.scrollTop()};
            if (c.mobile && f.ignoreMobile || c.overlay && f.ignoreOverlay || c.macosx && !c.webkit)return !1;
            if (p)s.css({height: "", "margin-bottom": -1 * c.scroll.height + l, "margin-right": -1 * c.scroll.width + l}); else {
                if (this.wrapper = p = e("<div>").addClass("scroll-wrapper").addClass(o.attr("class")).css("position", "absolute" == o.css("position") ? "absolute" : "relative").insertBefore(o).append(o), o.is("textarea") && (this.containerWrapper = s = e("<div>").insertBefore(o).append(o), p.addClass("scroll-textarea")), s.addClass("scroll-content").css({
                        ...
                        e.isFunction(f.onScroll) && f.onScroll.call(r, {maxScroll: d.y.maxScrollOffset, scroll: o.scrollTop(), size: d.y.size, visible: d.y.visible}, {
                    ...
                    p.on({"MozMousePixelScroll.scrollbar": v, "mousewheel.scrollbar": v}), c.mobile && p.on("touchstart.scrollbar", function (n) {
                        var r = n.originalEvent.touches && n.originalEvent.touches[0] || n, i = {pageX: r.pageX, pageY: r.pageY}, a = {left: o.scrollLeft(), top: o.scrollTop()};
                        e(t).on({
            ...
            e.each(d, function (n, s) {
                var l = null, c = 1, p = "x" == n ? "scrollLeft" : "scrollTop", h = f.scrollStep, v = function () {
                    var e = o[p]();
                ...
                s.scrollbar || (s.scrollbar = r.getScrollbar(n), s.scroller = s.scrollbar.find(".scroll-bar"), s.mousewheel = function (e) {
                    ...
                    var t = -1 * e.originalEvent.wheelDelta || e.originalEvent.detail, i = s.size - s.visible - s.offset;
                    ...
                    "MozMousePixelScroll.scrollbar": s.mousewheel, "mousewheel.scrollbar": s.mousewheel, "mouseenter.scrollbar": function () {
                        g = o[p]()
                    }
                ...
                var n = "scroll-scroll" + e + "_visible", r = "x" == e ? d.y : d.x;
                t.scrollbar.removeClass(n), r.scrollbar.removeClass(n), s.removeClass(n)
            }), e.each(d, function (t, n) {
                e.extend(n, "x" == t ? {offset: parseInt(o.css("left"), 10) || 0, size: o.prop("scrollWidth"), visible: p.width()} : {
            ...
            var g = function (t, n) {
                var r = "scroll-scroll" + t + "_visible", i = "x" == t ? d.y : d.x, a = parseInt(o.css("x" == t ? "left" : "top"), 10) || 0, u = n.size, f = n.visible + a;
            ...
            e.each(d, g), e.isFunction(f.onUpdate) && f.onUpdate.apply(this, [o]), e.each(d, function (e, t) {
                var n = "x" == e ? "left" : "top", r = "x" == e ? "outerWidth" : "outerHeight", i = "x" == e ? "width" : "height", a = parseInt(o.css(n), 10) || 0, s = t.size, u = t.visible + a, c = t.scrollbar.find(".scroll-element_size");
    ...
    }, e.fn.scrollbar.options = f, n.angular && !function (e) {
    ...
    var p = 0, h = 0, v = function (e) {
        ...
        s && h > 10 ? (c.log("Scroll updates exceed 10"), v = function () {
        }) : (clearTimeout(p), p = setTimeout(v, 300))
    }
}(jQuery, document, window), !function (e, t, n, r) {
    var i = e(t);
...
}(jQuery, window, document), !function (_aoUndefined) {
    ...
    function _compareVersion(e, t) {
        for (var n = e.split("."), r = n.length, i = t.split("."), o = i.length, a = 0; r > a && o > a; a++) {
            var s = parseInt(n[a]), u = parseInt(i[a]);
    ...
    var e = function () {
        ...
        var t = 90 == Math.abs(window.orientation) ? screen.height : screen.width, n = t / window.innerWidth;
        ...
        return i = Math.round(100 * i) / 100, document.body.removeChild(r), {zoom: i, devicePxPerCssPx: i * e()}
    }, u = function () {
        var e = f("min--moz-device-pixel-ratio", "", 0, 10, 20, 1e-4);
        return e = Math.round(100 * e) / 100, {zoom: e, devicePxPerCssPx: e}
    }, l = function () {
        return {zoom: u().zoom, devicePxPerCssPx: e()}
    }, c = function () {
    ...
    e.Range = function (t) {
        ...
        moveToPoint: function (t) {
            ...
            var n = this.compare("START_TO_START", t), r = this.compare("END_TO_END", t);
            ...
            if (void 0 === t) {
                if (this.range.startContainer)return {container: this.range.startContainer, offset: this.range.startOffset};
                var n = this.clone().collapse().parent(), r = e.Range(n).select(n).collapse();
                return r.move("END_TO_START", this), {container: n, offset: r.toString().length}
            }
            if (this.range.setStart)if ("number" == typeof t)this.range.setStart(this.range.startContainer, t); else if ("string" == typeof t) {
                var i = c(this.range.startContainer, this.range.startOffset, parseInt(t, 10));
                this.range.setStart(i.node, i.offset)
            } else this.range.setStart(t.container, t.offset); else if ("string" == typeof t)this.range.moveStart("character", parseInt(t, 10)); else {
            ...
            if (void 0 === t) {
                if (this.range.startContainer)return {container: this.range.endContainer, offset: this.range.endOffset};
                var n = this.clone().collapse(!1).parent(), r = e.Range(n).select(n).collapse();
                return r.move("END_TO_END", this), {container: n, offset: r.toString().length}
            }
            if (this.range.setEnd)if ("number" == typeof t)this.range.setEnd(this.range.endContainer, t); else if ("string" == typeof t) {
                var i = c(this.range.endContainer, this.range.endOffset, parseInt(t, 10));
                this.range.setEnd(i.node, i.offset)
            } else this.range.setEnd(t.container, t.offset); else if ("string" == typeof t)this.range.moveEnd("character", parseInt(t, 10)); else {
            ...
            var t = this.range.parentElement(), n = this.range;
        ...
        var r = e.Range.prototype, i = e.Range().range;
    ...
    var o = function (e, t) {
    ...
    }, u = s("firstChild", "nextSibling"), l = s("lastChild", "previousSibling"), c = function (e, t, n) {
        var r = 0 > n ? l : u;
        ...
        return {node: e, offset: n === u ? t : e.nodeValue.length - t}
    }, d = function (e, t) {
        return e.left <= t.clientX && e.left + e.width >= t.clientX && e.top <= t.clientY && e.top + e.height >= t.clientY
    }, p = function (e, t) {
        return d(e, {clientX: t.left, clientY: t.top}) && d(e, {clientX: t.left + t.width, clientY: t.top}) && d(e, {clientX: t.left, clientY: t.top + t.height}) && d(e, {
