 ...
 */
define("common/directives/spinner", ["angular"], function (angular) {
  "use strict"
...
define("common/directives/loading", ["angular", "$directives", "./spinner"], function (angular, $directives, Spinner) {
  $directives.directive("loading", function () {
    return {
      ...
      link: function (scope, element, $attr) {
        ...
        }, option = options[$attr.size] || options[16];
        option.zIndex = 99;
        new Spinner(option).spin(element[0])
      }
    }
  })
})
